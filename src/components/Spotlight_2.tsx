  ...
  return (
    ...
    <Box
      ...
      sx={{
        ...
        py: { xs: 5, md: 10 }, // Padding vertical 
        // DIAGONAL SUPERIOR
        '&::before': {
        content: '""',
        position: 'absolute',
    ...
    >
      ...
      <Box
        ...
        sx={{
          ...
          py: { xs: 3, md: 4 }, // Añade padding vertical al inner si es necesario para separar de las diagonales en móviles
          display: 'grid',
      ...
      >
        ...
        <Box
          sx={{
            ...
            order: { xs: 1, ms: 'minmax(350px, 1)', md: 1 }, // Cambia el orden: imagen 2da en xs, 1ra en md
            overflow: 'hidden',
        ...
        <Box
          sx={{
            ...
            order: { xs: 2,ms:2, md: 2 }, // Cambia el orden: texto 1ro en xs, 2do en md
            maxWidth: { xs: '100%', md: '80em' }, // O un valor en % como '70%'
